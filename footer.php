            ...
            while($custom_query->have_posts()) : $custom_query->the_post(); ?>
                    ...
                    <div class="item_controls">
                        ...
                        <div class="item_switch">
                            <div class="switch_left"onclick="plusItem(-1)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26.981"
                ...
                <div class="service_preview ">
                    ...
                    <div class="preview_item">
                        ...
                        ?></div>
                        <div class="preview_goto"><a href="<?php echo get_permalink( get_the_ID() ) ?>">Procitaj sve</a></div>
                    </div>
                    <div class="backbutton"><div>Nazad</div></div>
                </div>
            </div>
         ...
         <div class="category_items">
            ...
            <div class="service_items ">
                ...
                <div class="service_preview ">
                    ...
                    <div class="preview_item">
                        <div class="preview_title">O usluzi</div>
                        <div class="preview_text"><?php $content = the_content(); echo mb_strimwidth($content, 0, 400, '...');?></div>
                        <div class="preview_goto"><a href="<?php echo get_permalink( get_the_ID() ) ?>">Procitaj sve</a></div>
                    </div>
                    <div class="backbutton"><div>Nazad</div></div>
                </div>
